var nrpPlayer = angular.module('MyPlayer',[]);

nrpPlayer.controller('videoController',function(){

});

nrpPlayer.directive('videoPlayer',function(){
    return {
        restrict:'EA',
        scope:{},
        templateUrl:'player.html',
        link:function(scope,iele,iattrs){
            scope.audio = iele[0].getElementsByTagName('video')[0];
